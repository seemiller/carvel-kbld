...
func NewResolveCmd(o *ResolveOptions) *cobra.Command {
	...
	cmd.Flags().BoolVar(&o.UnprocessedImageInspect, "unprocessed-images-inspect", false, "List image references found in inputs")
	return cmd
}
